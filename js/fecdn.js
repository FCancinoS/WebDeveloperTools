...
const cdns = {
    ...
    "worldBtn": '<i class="fa-solid fa-earth-americas"></i>',
    "houseBtn": '<i class="fa-solid fa-house"></i>',
    "phoneBtn": '<i class="fa-solid fa-phone"></i>',
    "hamburgerBtn": '<i class="fa-solid fa-bars"></i>',
    "githubBtn": '<i class="fa-brands fa-github"></i>',
    "discordBtn": '<i class="fa-brands fa-discord"></i>',
    "heartBtn": '<i class="fa-regular fa-heart"></i>',
    "instaBtn": '<i class="fa-brands fa-instagram"></i>',
    "downloadBtn": '<i class="fa-solid fa-download"></i>',
    "searchBtn": '<i class="fa-solid fa-magnifying-glass"></i>',
    "arrightBtn": '<i class="fa-solid fa-arrow-right"></i>',
    "clipBtn": '<i class="fa-solid fa-paperclip"></i>',
    "fontGothic": '<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Gothic+A1&family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap" rel="stylesheet">',
    "fontRalew": '<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Raleway:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">',
